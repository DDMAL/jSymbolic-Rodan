...
class extract_features(RodanTask):
    ...
    def run_my_task(self, inputs, settings, outputs):
        ...
        with self.tempdir() as temp_dir:
            ...
            shutil.copyfile(temp_value_path, outputs['jSymbolic ACE XML Value Output'][0]['resource_path'])

            # Assign files generated by jSymbolic to definition output port
            shutil.copyfile(temp_definition_path, outputs['jSymbolic ACE XML Definition Output'][0]['resource_path'])
